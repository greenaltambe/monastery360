...
const features = [
  {
    name: "Virtual Tour",
    description:
      "Step inside monasteries with immersive 360° virtual experiences.",
    to: "/virtualtour",
    icon: MapPinIcon,
  },
  {
      ...
      <div className="relative isolate px-6 pt-20 lg:px-8 min-h-screen">
        ...
        <div className="relative mx-auto max-w-3xl text-center">
          ...
          <p className="mt-6 text-lg leading-8 text-white">
            Explore the spiritual heart of Sikkim — discover monasteries, join
            virtual tours, browse archives, and experience events in one place.
          </p>
